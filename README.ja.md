...
| -u       | 自動判定   | stable/flippy/beta/rk3588/rk35xx | カーネルの[タグサフィックス](https://github.com/ophub/kernel/releases)を設定 |
